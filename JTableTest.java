...
public class JTableTest extends JFrame{
	...
	Object data[][] = { {1, "홍길동","010-1111-2222", "abcde@naver.com", "서울시 마포구 백범로"},
						...
						{3, "이순신", "010-3333-4444","xzxzxz@hanmail.com","서울시 강남구 논현로"},
						{4, "장영실","010-4444-5555","ttttt@nate.com","서울시 영등포구"},
						{5, "유승룡","010-6666-7777","zkzkzkzzk@naver.com","서울시 동작구"}};
	...
	public JTableTest() {
	    ...
	    try {Thread.sleep(3000);}catch(Exception e) {}
		//레코드 삽입
		Object inData4[] = {7, "BBBB","010-8888-8888","djdjdjd@nate.com","서울시 은평구"};
		model.addRow(inData4); 
//		try {Thread.sleep(3000);}catch(Exception e) {}
//		//행삭제
//		model.removeRow(3);
//		
...
//		table.removeColumn(table.getColumn("비고"));
		...
		table.addMouseListener(new MouseAdapter() {
			//마우스를 누른후 손을 놓으면 호출되는 메소드
			public void mouseReleased(MouseEvent me) {
				int btn = me.getButton(); //1:왼쪽버튼, 2:휠, 2:오른쪽버튼
				if(btn == 1) {//마우스 왼쪽 버튼을 누른경우
