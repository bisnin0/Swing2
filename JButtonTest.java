...
public class JButtonTest extends JFrame{
	...
	ImageIcon ii2 = new ImageIcon("img/2.png");
	ImageIcon ii3 = new ImageIcon("img/3.jpg");
	ImageIcon ii4 = new ImageIcon("img/4.jpg");
	ImageIcon ii5 = new ImageIcon("img/5.jpg");
	public JButtonTest() {
		super("JButton");
		...
		btn3.setPressedIcon(ii4);// 버튼을 누른상태일때 icon변경
		...
		add(tBtn);
		tBtn.setSelectedIcon(ii1);//버튼이 선택상태일때 아이콘
